package com.application.composer.util;
...
public class Constants {
	...
	public static final String ADJECTIVE_SERVICE_NAME = "adjective-sentence-composer";
	public static final String NOUN_SERVICE_NAME = "noun-sentence-composer";
}
